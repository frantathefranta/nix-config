...
in
{
  services.custom-wireguard.interfaces = {
    ...
    "ebgp_4242422466" = {
      listenPort = 22466;
      peerEndpoint = "netzilla.xhustudio.eu.org:21033";
      peerPublicKey = "NneXyO6ANmBoREGcDQh/KCi2MtkAGU4xS/HIkNB8wQg=";
    ...
    "ebgp_4242421123" = {
      listenPort = 21123;
      peerPublicKey = "e5X1ZlZUOVtTFeWi+d6cUqqNaXB0F2UHwbquAKU4z3I=";
